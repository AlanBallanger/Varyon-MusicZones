...
public final class Pos1SubCommand extends MusicZoneAdminCommandBase {

    public Pos1SubCommand() {
        super("pos1", "Mémoriser la première extrémité du parallélépipède (ta position)");
    }
    ...
    protected void executeSync(@Nonnull CommandContext context) {
        ...
        plugin.setPendingCorner1(p.getWorld().getName(), uuid, x, y, z);
        context.sendMessage(Message.raw("pos1 enregistré (" + fmt(x) + ", " + fmt(y) + ", " + fmt(z) + ")."));
    }
